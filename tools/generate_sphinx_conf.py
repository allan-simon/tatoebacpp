...
index common_index
{
    index_exact_words       = 1
    charset_table           = \\
          0..9, a..z, _, A..Z->a..z, U+00C0->a, U+00C1->a, U+00C2->a, U+00C3->a, U+00C4->a,       \\
          ...
          \\
          U+1EF4->y, U+1EF5->y, U+1EF6->y, U+1EF7->y, U+1EF8->y, U+1EF9->y, U+621..U+63a, \\
          U+640..U+64a, \\
          \\
          ...
          U+391..U+3a1->U+3b1..U+3c1,\\
          \\
          U+3a3..U+3ab->U+3c3..U+3cb, U+3ac..U+3ce, U+3d0..U+3d7, U+3d8..U+3ef/2, U+3f0..U+3f3, \\
          U+3f4->U+3b8,\\
          \\
          ...
          U+C0..U+D6->U+E0..U+F6, U+D8..U+DE->U+F8..U+FE, U+178->U+FF, U+FF, U+100..U+177/2, \\
          U+179..U+17E/2,\\
          U+980..U+9FC,\\
...
for isoCode, array in data["tatoeba"]["languages"].iteritems():
    ...
    # print source part
    xmlDumpPathTmp = xmlDumpPath + "_" + isoCode
    print "source " + isoCode + "_src : default { \n"
    print "  xmlpipe_command = cat " + xmlDumpPathTmp
    print " xmlpipe_field      = tatotext"
    print " xmlpipe_attr_multi = translatedin"
    print " }\n\n"

    print "index " +  isoCode + " : ",
    if isoCode in cjkLanguages :
        print "cjk_common_index {\n"
    else :
        print "common_index {\n"

    #print indexPath
    print "   source = " + isoCode + "_src"
    print "   path = " + indexPath + isoCode
    if isoCode in languageWithStemmer:
        print "morphology              = libstemmer_" + isoCode
        print "min_stemming_len        = 4"

    print "}"


print "index und : common_index {"
